...
public class Lab4ExtendWeightedGrades {
    ...
    public double getfinalGrade(ArrayList<Integer> assignList, ArrayList<Double> earnedList,ArrayList<Double> precentageList) {
        for (int i = 0; i < assignList.size(); i++) {
            this.finalGrade += earnedList.get(i) / assignList.get(i) * precentageList.get(i) * 100;
        }
        return finalGrade;
    }

    public Lab4ExtendWeightedGrades(){
        }
